Gem::Specification.new do |s|
  ...
  s.files       = ["lib/fsinv.rb","lib/fsinv/directorydescription.rb","lib/fsinv/filedescription.rb","lib/fsinv/fsinventory.rb","lib/fsinv/lookuptable.rb","lib/fsinv/basedescription.rb"]
  s.executables << 'fsinv'
