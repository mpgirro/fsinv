Gem::Specification.new do |s|
  ...
  s.files       = ["lib/fsinv.rb","lib/fsinv/directorydefinition.rb","lib/fsinv/filedefinition.rb","lib/fsinv/fsinventory.rb","lib/fsinv/lookuptable.rb","lib/fsinv/basedefinition.rb"]
  s.executables << 'fsinv'
